// PDF BUILDER — Atelier A2: Negation (nicht vs kein)
(function () {
    ...
    function buildCast() {
        return `<div class="cast-banner">
            ...
            <div class="cast-grid">
                <div class="cast-card"><img src="images/andreea.png" alt="Andreea"><div class="name">Andreea 🇷🇴</div><div class="detail">Spune NU</div></div>
                <div class="cast-card"><img src="images/carolina.png" alt="Carolina"><div class="name">Carolina</div><div class="detail">Pune întrebări</div></div>
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Negation (nicht vs kein)</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += fillPromptBlock('Übung 1 — Forma lui kein-', 'Se declină ca ein-/mein-: kein/keine/keinen/keinem/keiner.', ex1Data);
        }
        if (typeof ex2Data !== 'undefined') {
            html += choiceBlock('Übung 2 — nicht sau kein?', 'Substantiv cu ein / fără articol → kein. Verb / adjectiv / der / mein → nicht.', ex2Data);
        }
        if (typeof ex3Data !== 'undefined') {
            html += fillPromptBlock('Übung 3 — Poziția lui nicht', 'Negi tot → nicht la final. Negi o parte → nicht înaintea ei.', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += fillPromptBlock('Übung 4 — Neagă propoziția', 'Substantiv cu ein/fără articol → kein; restul → nicht.', ex4Data);
        }
        if (typeof ex5Data !== 'undefined') {
            html += translateBlock('Übung 5 — Traducere RO → DE', 'substantiv cu ein/fără articol → kein; restul → nicht; „ba da" → Doch.', ex5Data);
        }
        return html;
    }
    ...
    function buildVerbs() {
        let html = `<h1 class="chapter new-section">🔁 4. Verbe pentru exemple de negație — Präsens · Präteritum · Perfekt</h1>
            <div class="andreea-note">
                <div class="andreea-note-content">
                    <div class="speaker">📌 Andreea îți spune:</div>
                    <div>Cu kennen/verstehen/glauben negi cu nicht (Ich verstehe das nicht). Cu mögen/brauchen/essen + substantiv negi cu kein (Ich mag keinen Kaffee, Ich esse kein Fleisch). essen e tare (isst; aß → gegessen).</div>
                </div>
            </div>`;
